...
class SGLangEngine(RayActor):
    ...
    def _init_normal(self, server_args_dict):
        ...
        # ServerArgs refuses writes once its declarations materialise, so the
        # IPv6 host loses its brackets here rather than at the launch sites.
        # Keep the original dict unchanged because self.server_host uses it to
        # build URLs.
