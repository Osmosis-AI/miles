...
OUT=/workspace/andy-miles-update/pre-upstream/full-parameter
...
rm -rf "${OUT}"
mkdir -p "${OUT}"
cp "${REPO}/metrics/pre-upstream/full-parameter/launch.sh" "${OUT}/launch_command.sh"
cp "${REPO}/metrics/pre-upstream/full-parameter/profile.yaml" "${OUT}/profile.yaml"
